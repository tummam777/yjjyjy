...
local Window  = Library.CreateLib("Pop it trading v1.3 made by xovgaming", "DarkTheme")
local Tab     = Window:NewTab("Main Scripts")
local Section = Tab:NewSection("Buy NFTS")
local Section = Tab:NewSection("Click Tab on the Keyboard to open and Close")
...
local Section = Tab:NewSection("Thats all for this Update")
                local Section = Tab:NewSection("Now the Dupe Start up is in the Auto dupe Tab ")
local Section = Tab:NewSection("added New Tab Named Auto sell & Auto Buy")
local Section = Tab:NewSection("added Auto Buy Watermelon on Anti Reaper Tab")
local Section = Tab:NewSection("added Slow Gravity on Scripts tab")
local Section = Tab:NewSection("addeed Fly Gui on Scripts tab")
